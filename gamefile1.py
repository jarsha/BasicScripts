...
#Defining Character and Road Images
def character(x,y):
    theDisplay.blit(char_img,(x,y))

def the_road():
    theDisplay.blit(road_img,(0,0))
...
def wall_death():
    display_message('Fell into the ditch!')

def box_crush():
    display_message('Tripped on a box!')
    

#Player Score
def player_score(score):
    font = pygame.font.SysFont(None, 30)
    text = font.render("Boxes Dodged: "+str(score), True, black)
    theDisplay.blit(text, (15,0))
...
def game_loop():
    ...
    box_start_x = random.randrange(90,display_width)
    ...
    while not game_exit:
        ...
        dodge_me(box_start_x, box_start_y, box_width, box_height, green)
